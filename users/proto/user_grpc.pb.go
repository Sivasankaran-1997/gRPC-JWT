...
type UserServiceClient interface {
	...
	Login(ctx context.Context, in *ProtoLoginRequest, opts ...grpc.CallOption) (*ProtoLoginResponse, error)
...
func (c *userServiceClient) Login(ctx context.Context, in *ProtoLoginRequest, opts ...grpc.CallOption) (*ProtoLoginResponse, error) {
	out := new(ProtoLoginResponse)
...
type UserServiceServer interface {
	...
	Login(context.Context, *ProtoLoginRequest) (*ProtoLoginResponse, error)
...
func (UnimplementedUserServiceServer) Login(context.Context, *ProtoLoginRequest) (*ProtoLoginResponse, error) {
...
func _UserService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Login(ctx, req.(*ProtoLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
